...
function afficherDetail(r){
  ...
  box.innerHTML=`
    <div class="d-tete">
      ...
      <div class="d-region">${r.region} · ${typeLbl}</div>
    ...
    <div class="d-section">
      <h3>Informations</h3>
      <div class="d-grille">
        <div class="d-cell"><div class="l">Altitude</div><div class="v">${r.alt?r.alt+' m':'—'}</div></div>
        <div class="d-cell"><div class="l">Places</div><div class="v">${r.places||'—'}</div></div>
        <div class="d-cell"><div class="l">Eau à proximité</div><div class="v" id="cell-eau-proximite" style="color:${eau==='Oui'?'var(--cyan)':eau==='Non'?'var(--texte-3)':'var(--texte)'}">${eau||'—'}</div></div>
        <div class="d-cell"><div class="l">Bois</div><div class="v" style="color:${bois==='Oui'?'var(--ambre)':bois==='Non'?'var(--texte-3)':'var(--texte)'}">${bois||'—'}</div></div>
      </div>
      ${friseEau(r)}
